...
public interface AsesoriaEncuestaRepository extends JpaRepository<AsesoriaEncuestaVO,Integer> {
    ...
    @Query("SELECT ae FROM AsesoriaAsignacionVO aa  JOIN AsesoriaControlVO ac ON aa.id_Asesoria = ac.idAsesoria "
    ...
    List<AsesoriaEncuestaVO> listaEncuestaSeleccion (@Param("str_Matricula")  String str_Matricula, @Param("str_Periodo") String str_Periodo, @Param("int_IdPrograma") int int_IdPrograma);
}
